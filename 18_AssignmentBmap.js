...
const arrayOfNames = arryEmployee.map( (element ) => {
    return element.emp_salary;
});
console.log(`List of all employee salary==> ${arrayOfNames}`);
console.log(``);
console.log(`-------------step 2-------------------------------`);
console.log(`----------------List of all employee Department----------------------------------------`);
const arrayOfNames1 = arryEmployee.map( (element ) => {
    return element.emp_dept;
});
console.log(`List of all employee Department==> ${arrayOfNames1}`);
console.log(``);
console.log(`-------------step 3-------------------------------`);
console.log(`----------------List of all employee ID's----------------------------------------`);
const arrayOfNames2 = arryEmployee.map( (element ) => {
    return element.emp_id;
});
console.log(`List of all employee ID's==> ${arrayOfNames2}`);